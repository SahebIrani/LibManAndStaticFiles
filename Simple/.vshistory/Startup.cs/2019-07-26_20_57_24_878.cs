...
namespace Simple
{
	public class Startup
	{
		...
		public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
		{
			...
			//			{
			//				if (response.Context.User.IsInRole("Admin")) return;
			//				else response.Context.Response.StatusCode = (int)HttpStatusCode.Unauthorized;
			//			}
			//			else
			...
			app.UseStaticFiles(new StaticFileOptions
			{
				OnPrepareResponse = x =>
				{
					...
					{
						x.Context.Response.WriteAsync("yani Chi");
					}
				}
			});
			app.UseDefaultFiles();
